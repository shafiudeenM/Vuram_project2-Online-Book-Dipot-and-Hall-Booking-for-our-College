<?php 
     ...
     $date_now  = date("Y-m-d H:i:s");
      ...
      $sql="update hall
      SET STATUS = 'APPROVED',NSTATUS='REJECTED',DELETS=null
      where HID= $O ";
...
<link rel="stylesheet" href="css/style.css">
    ...
    <div class=container style="float: right;" >
     ...
     <?php
         $sql= " select hall.HALL,hall.HID,hall.NSTATUS,hall.SESSION,hall.STATUS,hall.COUNT,hall.DEPARTMENT,hall.PURPOSE,hall.TIME,user.UNAME from hall inner join user on hall.UID=user.UID";
          $res=$db->query($sql);

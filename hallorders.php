...
<link rel="stylesheet" href="css/style.css">
    ...
    <div class=container style="float: right;" >
     ...
     <?php
         $sql= " select hall.HALL,hall.HID,hall.SESSION,hall.COUNT,hall.DEPARTMENT,hall.PURPOSE,hall.TIME,user.UNAME from hall inner join user on hall.UID=user.UID";
          $res=$db->query($sql);

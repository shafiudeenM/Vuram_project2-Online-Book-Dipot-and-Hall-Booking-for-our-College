...
<link rel="stylesheet" href="css/style.css">
    ...
    <div class=container style="float: right;" >
     ...
     <?php
         $sql= " select user.UNAME,dipot.DELETS,dipot.ETIME, dipot.OID,dipot.DEPARTMENT,dipot.REQUIREMENT,dipot.YEAR,dipot.STATUS,dipot.QUANTITY,dipot.TIME FROM 
          ...
          if($res->num_rows>0)
          {
              ...
              while($row= $res->fetch_assoc())
              {
                    ...
                    if ($date_now > $row["ETIME"]) {
                     ...
                     echo "<td>$a</td>";
                      ...
                      echo "<td><a href='deletebook.php?i={$row["OID"]}'>{$row["DELETS"]}</a></td>";
                      }
             ...
             echo" </table>";
              ...
              echo "<p class='sucess' > Order Deleted Sucessfully</p>";
          }
          ?>

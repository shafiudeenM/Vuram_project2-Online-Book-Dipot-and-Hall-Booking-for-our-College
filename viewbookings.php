...
<link rel="stylesheet" href="css/style.css">
    ...
    <div class=container style="float: right;" >
     ...
     <?php
      $h= $_SESSION["NAME"];
         $sql= "  select hall.HID,hall.HALL,hall.STIME,hall.SESSION,hall.STATUS,hall.COUNT,hall.DEPARTMENT,hall.PURPOSE,hall.ETIME,hall.DELETS,
         hall.TIME,user.UNAME from hall inner join user on hall.UID={$_SESSION["ID"]} where User.UNAME= '$h'";
          $res=$db->query($sql);
